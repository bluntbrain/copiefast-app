...
class SmartWebView {
	...
	// URL configs
	static String ASWV_URL            = "https://copie-fast.blogspot.com/";     // complete URL of your website or offline webpage
	...
	// admob config
	static String ASWV_ADMOB          = "ca-app-pub-5083455238941663~5969406857"; // your unique publishers ID; this one is temporary
